...
export type ExportFormat =
  'rvm' | 'rvmtxt' | 'glb' | 'gltf' | 'obj' | 'stl' | 'stlascii' | 'ply' | 'plybin' | 'png' | 'html' | 'pdf';
...
export interface RvmOps {
  ...
  setProperty: {
    payload: HandlePayload & SegmentsPayload & { name: string; value: unknown };
    result: { newValue: string; [key: string]: unknown };
  };
  /** 删除属性。 */
  removeProperty: {
    payload: HandlePayload & SegmentsPayload & { name: string };
